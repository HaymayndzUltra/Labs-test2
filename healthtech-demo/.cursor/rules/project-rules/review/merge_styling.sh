#!/bin/bash
# Enhance web-styling.mdc with Tailwind and Bootstrap content

cat > /workspace/healthtech-demo/.cursor/rules/project-rules/styling.mdc << 'STYLING_EOF'
---
...
rm -f /workspace/healthtech-demo/.cursor/rules/project-rules/tailwind.mdc
rm -f /workspace/healthtech-demo/.cursor/rules/project-rules/bootstrap.mdc
