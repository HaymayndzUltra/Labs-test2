...
cat > /workspace/healthtech-demo/.cursor/rules/project-rules/testing.mdc << 'TESTING_EOF'
---
...
rm -f /workspace/healthtech-demo/.cursor/rules/project-rules/playwright.mdc
rm -f /workspace/healthtech-demo/.cursor/rules/project-rules/rspec.mdc
rm -f /workspace/healthtech-demo/.cursor/rules/project-rules/go-testing.mdc
