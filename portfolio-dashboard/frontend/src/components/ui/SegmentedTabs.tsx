      ...
      {tabs.map((tab) => {
        ...
        return (
          <button
            ...
            className={cn(
              'relative flex min-w-[160px] flex-1 items-center justify-center gap-2 rounded-[18px] px-4 py-3 text-sm font-semibold transition-all duration-300 focus-visible:focus-ring',
              isActive
                ? 'tab--active'
