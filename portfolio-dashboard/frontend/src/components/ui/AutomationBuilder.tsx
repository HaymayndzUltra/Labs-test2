        ...
        <form className="grid gap-4" onSubmit={onSubmit}>
          <label className="grid gap-2 text-sm">
            ...
            <input
              ...
              placeholder="e.g. Enterprise customers, Free tier users"
            />
            {errors.audience ? <span className="text-xs text-[var(--danger-600)]">{errors.audience.message}</span> : null}
          </label>
          <label className="grid gap-2 text-sm">
          ...
          <label className="grid gap-2 text-sm">
            ...
            <textarea
              {...register('conditions')}
              className="min-h-[120px] rounded-[14px] border border-[var(--surface-border)] bg-[var(--surface-s1)] px-4 py-3 text-sm text-slate-700 focus-visible:focus-ring"
              rows={3}
          ...
          <div className="flex flex-col gap-3 pt-2">
            ...
            <button
              type="submit"
              className="inline-flex min-h-[44px] w-full items-center justify-center gap-2 rounded-full bg-[var(--primary-600)] px-5 py-2 text-sm font-semibold text-white shadow-sm transition hover:bg-[var(--primary-500)] focus-visible:focus-ring"
              disabled={submitting}
            >
