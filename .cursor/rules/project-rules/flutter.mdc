...
- Implement @JsonKey(includeFromJson: true, includeToJson: false) for read-fields.

Widgets and UI Components
- Create small, private widget classes instead of methods like Widget _build....
- Implement RefreshIndicator for pull-to-refresh functionality.
- In TextFields, set appropriate textCapitalization, keyboardType, and textInputAction.
- include an errorBuilder when using Image.network.
...
- Controller takes methods as input and updates the UI state that effects the UI
...
- Avoid Nesting Widgets Deeply in Flutter. Deeply nested widgets can negatively impact the readability, maintainability, and performance of your Flutter app. Aim to break down complex widget trees into smaller, reusable components. This not makes your code cleaner but also enhances the performance by reducing the build complexity
