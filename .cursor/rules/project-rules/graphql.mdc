...
AI SDK
- use Vercel AI SDK UI for implementing streaming chat UI.
- use Vercel AI SDK Core to interact with language models.
- use Vercel AI SDK RSC and Stream Helpers to stream and help with the generations.
...
- Code in services/ dir throw user-friendly errors that can be caught and shown to the user.
...
- use generated GraphQL client (Genql) for type-safe API interactions with Supabase.
- Optimize GraphQL queries to fetch necessary data.
