---
description: "TAGS: [global,workflow,bootstrap,context,engineering,analysis,configuration] | TRIGGERS: bootstrap,project,setup,context,analysis,configuration,start,initialize | SCOPE: global | DESCRIPTION: Defines the complete project bootstrap and context engineering protocol for initial AI collaboration setup with tooling configuration and codebase analysis."
---

# Master Rule: Project Bootstrap & Context Engineering Protocol
