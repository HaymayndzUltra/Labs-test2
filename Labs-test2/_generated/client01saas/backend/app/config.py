...
class Settings(BaseSettings):
    ...
    TENANCY_MODEL: str = "column"
    BUILD_PROFILE: str = "prototype"
    ...
    def derive_secret(cls, v: Optional[str]) -> str:
    ...
    def sync_jwt_secret(cls, v: Optional[str]) -> Optional[str]:
        if v:
            return v
        env_secret = os.environ.get("JWT_SECRET")
        return env_secret
