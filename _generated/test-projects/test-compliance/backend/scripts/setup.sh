#!/bin/bash
# Initial setup script for test-compliance Django backend

set -e

echo "🚀 Setting up test-compliance Django backend..."
...
echo "  2. Start Celery: celery -A test-compliance worker --loglevel=info"
