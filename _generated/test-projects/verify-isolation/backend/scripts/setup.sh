#!/bin/bash
# Initial setup script for verify-isolation Django backend

set -e

echo "🚀 Setting up verify-isolation Django backend..."
...
echo "  2. Start Celery: celery -A verify-isolation worker --loglevel=info"
