#!/bin/bash
# Initial setup script for accept-nextjs-django Django backend

set -e

echo "🚀 Setting up accept-nextjs-django Django backend..."
...
echo "  2. Start Celery: celery -A accept-nextjs-django worker --loglevel=info"
