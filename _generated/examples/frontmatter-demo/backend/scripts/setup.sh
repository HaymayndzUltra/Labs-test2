#!/bin/bash
# Initial setup script for frontmatter-demo Django backend

set -e

echo "🚀 Setting up frontmatter-demo Django backend..."
...
echo "  2. Start Celery: celery -A frontmatter-demo worker --loglevel=info"
