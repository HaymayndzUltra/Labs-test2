-- rule-verify-2 Database Initialization
...
-- enterprise specific tables and configurations would go here
...
-- Comments
COMMENT ON SCHEMA app IS 'rule-verify-2 application schema';
